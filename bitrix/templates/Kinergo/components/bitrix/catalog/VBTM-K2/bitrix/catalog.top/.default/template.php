...
<h2 class="nodes-title">Список плит</h2>
            ...
            <li class="luitop">
                <div class='image'>
                    <a style="text-align:center;display:inline-block;width:100%"
                       deturl='<?= $arItems['DETAIL_PAGE_URL']; ?>' <? if ($aut == 1) {
                        echo "href='" . $arItems['DETAIL_PAGE_URL'] . "'";
                    } else {
                        echo "href='" . $arItems['DETAIL_PAGE_URL'] . "' class=''";
                    } ?>>
                        <img src='<?= $arResizeFile['src']//$arItems['PREVIEW_PICTURE']['SRC']; ?>' alt=''/>
                    </a>
                </div>
                <div class='info'>
                    <a deturl='<?= $arItems['DETAIL_PAGE_URL']; ?>' <? if ($aut == 1) {
                        echo "href='" . $arItems['DETAIL_PAGE_URL'] . "' class='header'";
                    } else {
                        echo "href='" . $arItems['DETAIL_PAGE_URL'] . "' class='header'";
                    } ?> ><?= $arItems['NAME']; ?></a>
